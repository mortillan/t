...
export default function CountBar({ task }) {
  ...
  return (
    <g>
      ...
      <text x='864' y='1560' fontSize='1160' fontWeight='900' width='864' fill='#ffffff'>{startTime.toLocaleTimeString(locale, settings)}</text>
      <text x='80500' y='1560' fontSize='1160' fontWeight='900' width='864' fill='#ffffff'>{endTime.toLocaleTimeString(locale, settings)}</text>
    </g>
  )
}